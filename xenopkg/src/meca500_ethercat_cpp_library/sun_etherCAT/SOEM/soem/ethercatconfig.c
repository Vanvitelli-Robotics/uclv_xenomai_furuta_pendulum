...
int ecx_config_init(ecx_contextt *context, uint8 usetable)
{
   ...
   if (wkc > 0)
   {
      ...
      {
         ADPh = (uint16)(1 - slave);
//l'indirzzo è configurato in base alla posizione poichè chi ha ADPh==0 legge o scrive
//per come funziona APRDw o APWRw; ogni slave per cui passa il frame incrementa la variabile
//indicata da ADPh
